...
final class ProductManualController extends AbstractController
{
    #[Route('/{productId}', name: 'app_admin_product_manual_index', methods: ['GET'])]
    public function index(ProductManualRepository $productManualRepository, int $productId, ProductRepository $productRepository): Response
    {
    ...
    public function edit(Request $request, ProductManual $productManual, EntityManagerInterface $entityManager, int $productId, ProductRepository $productRepository): Response
    {
        $product = $productRepository->find($productId);
    ...
    public function delete(Request $request, ProductManual $productManual, EntityManagerInterface $entityManager, int $productId, ProductRepository $productRepository): Response
    {
