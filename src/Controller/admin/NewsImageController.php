...
final class NewsImageController extends AbstractController
{
    #[Route('/{newsId}', name: 'app_admin_news_image_index', methods: ['GET'])]
    public function index(NewsImageRepository $newsImageRepository, int $newsId, NewsRepository $newsRepository): Response
    {
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, int $newsId, NewsRepository $newsRepository): Response
    {
        $news = $newsRepository->find($newsId);
    ...
    public function edit(Request $request, NewsImage $newsImage, EntityManagerInterface $entityManager, int $newsId, NewsRepository $newsRepository): Response
    {
        $news = $newsRepository->find($newsId);
    ...
    public function delete(Request $request, NewsImage $newsImage, EntityManagerInterface $entityManager, int $newsId, NewsRepository $newsRepository): Response
    {
        $news = $newsRepository->find($newsId);
