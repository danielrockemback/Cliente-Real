...
final class ProductImageController extends AbstractController
{
    ...
    public function index(ProductImageRepository $productImageRepository, int $productId, ProductRepository $productRepository): Response
    {
        $product = $productRepository->find($productId);

        return $this->render('admin/product_image/index.html.twig', [
            'product_images' => $productImageRepository->findBy(['product' => $product]),
            'product' => $product,
        ]);
    }
    ...
    public function edit(Request $request, ProductImage $productImage, EntityManagerInterface $entityManager, int $productId, ProductRepository $productRepository): Response
    {
        $product = $productRepository->find($productId);
    ...
    public function delete(Request $request, ProductImage $productImage, EntityManagerInterface $entityManager, int $productId, ProductRepository $productRepository): Response
    {
        $product = $productRepository->find($productId);
