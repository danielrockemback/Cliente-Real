...
class ProductCategory
{
    ...
    private ?File $imageProductFile = null;
    ...
    public function getImageProductFile(): ?File
    {
        return $this->imageProductFile;
    }

    public function setImageProductFile(?File $imageProductFile): void
    {
        $this->imageProductFile = $imageProductFile;

        if (null !== $imageProductFile) {
